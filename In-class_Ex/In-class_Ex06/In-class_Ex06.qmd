...
```{r}
pacman::p_load(tidyverse, readtext, corporaexplorer, quanteda, stringi, rvest, tidytext, igraph, tidygraph, ggraph, visNetwork, lubridate, clock, graphlayouts, jsonlite)
```
...
mc3_nodes <- as_tibble(mc3_data$nodes) %>%
  mutate(countru = as.character(country),
         id = as.character(id),
         product_services = as.character(product_services),
         revenue_omu = as.numeric(as.character(revenue_omu)), type = as.character(type)) %>%
